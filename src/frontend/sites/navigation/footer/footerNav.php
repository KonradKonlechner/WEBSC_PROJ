<div class="container mt-3 ">
    <ul class="nav justify-content-left footerNavBgColor footerNavBorderBottom pb-3 mb-3">
        <li class="nav-item col-6"><a href="../../content/information/impressum.php" class="px-2">Impressum</a></li>
        <li class="nav-item col-6"><a href="../../content/information/help.php" class="px-2">Hilfe & FAQ</a></li>
